...
class _questionsState extends State<questions> {
  ...
  void checkAnswer(String answer){
    if(data[2][questionnumber.toString()] == data[1][questionnumber.toString()][answer]){ //checks if the answer is correct
